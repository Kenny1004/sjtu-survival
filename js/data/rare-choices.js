...
Game.RARE_CHOICES = [
  // ===== 校园日常 =====
  { text: '🐱 校园里有只猫一直跟着你，带它去看了兽医', effect: { mental: 10, money: -5 } },
  ...
  { text: '🎂 给室友策划了一个惊喜生日派对', effect: { mental: 10, money: -5 } },
  ...
  { text: '📱 手机掉进思源湖了！', effect: { mental: -15, money: -8 } },

  // ===== 上海城市探索 =====
  { text: '🎡 一个人去了外滩，看了很久的黄浦江', effect: { mental: 10 } },
  { text: '🎪 上海迪士尼一日游！排队四小时玩了三个项目', effect: { mental: 18, money: -10, health: -8 } },
  { text: '📷 去武康路拍了一天文艺照', effect: { mental: 10, money: -3 } },
  { text: '🎬 在上海电影节看了一部大师作品', effect: { mental: 10, money: -5 } },
  { text: '🎻 去上海交响乐团听了场音乐会', effect: { mental: 12, money: -5 } },
  { text: '🚂 买了张火车票，周末一个人去了杭州', effect: { mental: 12, money: -5, health: -3 } },
  { text: '🏄 周末和朋友去金山冲浪', effect: { health: 8, mental: 10, money: -5 } },
  { text: '🧗 去了一次室内攀岩馆', effect: { health: 8, mental: 5, money: -3 } },
  { text: '🍜 发现五角场一家超隐蔽的神级小馆', effect: { mental: 8, money: -3 } },
  { text: '🎤 被朋友拉去KTV唱了一整晚', effect: { mental: 12, health: -8, money: -5 } },
  { text: '🧑‍🍳 去了一次农家乐，摘草莓喂鸡', effect: { mental: 10, money: -5, health: 3 } },
  { text: '🌃 坐在陆家嘴的天桥上看了一夜灯光', effect: { mental: 8, health: -3 } },

  // ===== 社交奇遇 =====
  { text: '🍺 在酒吧认识了一个超有意思的人', effect: { mental: 8, money: -5 } },
  ...
  { text: '🎪 参加了一场密室逃脱', effect: { mental: 8, money: -5 } },
  { text: '🧑‍🍳 和朋友一起做了顿大餐', effect: { mental: 10, money: -3, health: 3 } },
  { text: '💬 和很久没联系的老朋友重新取得了联系', effect: { mental: 8 } },
  { text: '🤝 参加了社区志愿者活动', effect: { mental: 12, health: -5 } },
  { text: '🎁 精心准备了一份礼物送给好朋友', effect: { mental: 5, money: -5 } },
  { text: '🧑‍🎤 被拉去当了一场婚礼的伴郎/伴娘', effect: { mental: 8, money: -5, health: -5 }, minSem: 5 },
  { text: '🎉 被邀请参加了一个很酷的主题派对', effect: { mental: 10, money: -5 } },
  ...
  { text: '🏋️ 办了张健身卡，信誓旦旦——去了三次就没去了', effect: { money: -5, mental: -3 } },
  ...
  { text: '🎮 Steam大促冲动消费了一波', effect: { money: -5, mental: 5 } },
  ...
  { text: '📱 换了新手机，心情莫名地好', effect: { mental: 8, money: -8 } },
  ...
  { text: '🍔 半夜点了份超丰盛外卖犒劳自己', effect: { mental: 5, money: -3, health: -3 } },
  { text: '💇 心血来潮换了个新发型', effect: { mental: 5, money: -3 } },
  ...
  { text: '🎰 抽盲盒上瘾，一口气拆了十个', effect: { money: -8, mental: 3 } },
  { text: '🧑‍🍳 尝试做饭，差点把厨房炸了', effect: { mental: -3, money: -3 } },
  ...
  { text: '🛒 双十一冲动消费，看到账单后悔了', effect: { money: -8, mental: -5 } },
  ...
  { text: '🚕 打车忘付钱，第二天补了双倍', effect: { money: -3, mental: -3 } },
