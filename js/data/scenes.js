...
Game.scenes = {
  ...
  s1_midterm_easy: {
    ...
    choices: [
      ...
      { text: '🎭 参加话剧社演出', hint: '心理+8, GPA-0.05, 金钱-5', next: 's1_end', effect: { mental: 8, gpa: -0.05, money: -5 } },
    ],
  },
  ...
  s2_intro: {
    ...
    choices: [
      ...
      { text: '🎵 加入学生乐队', hint: '心理+12, GPA-0.05, 金钱-5', next: 's2_event', effect: { mental: 12, gpa: -0.05, money: -5, flags: { _musicCount: 1, joinedBand: true } } },
      { text: '🔫 报名校CS电竞赛', hint: '心理+12, 体力-12, GPA-0.1, 金钱-5', next: 's2_cs_tournament', effect: { mental: 12, health: -12, gpa: -0.1, money: -5, flags: { csPlayer: true, csTournament: true, _csCount: 1 } } },
  ...
  s2_cs_tournament: {
    ...
    choices: [
      { text: '🏆 太爽了，继续打更高级别比赛', hint: '心理+6, GPA-0.1, 体力-5, 金钱-5', next: 's2_event', effect: { mental: 6, gpa: -0.1, health: -5, money: -5, flags: { csCompetitive: true } } },
  ...
  s2_romance: {
    ...
    choices: [
      { text: '💑 答应！在一起！', hint: '心理+14, 体力-8, GPA-0.05, 金钱-10', next: 's2_romance_start', effect: { mental: 14, health: -8, gpa: -0.05, money: -10, flags: { inRelationship: true, seriousRelation: true, _romanceCount: 1 } } },
      { text: '😏 暧昧一下就好，不想被束缚', hint: '心理+8, 金钱-8', next: 's2_fwb', effect: { mental: 8, money: -8, flags: { situationship: true, _romanceCount: 1 } } },
  ...
  s2_fwb: {
    ...
    choices: [
      ...
      { text: '💕 认真谈吧，给TA一个交代', hint: '心理+9, GPA-0.05, 金钱-10', next: 's2_event', effect: { mental: 9, gpa: -0.05, money: -10, flags: { inRelationship: true, seriousRelation: true, situationship: false, _romanceCount: 1 } } },
    ],
  },
  ...
  s3_intro: {
    ...
    groups: [
      ...
      { label: '📅 课余时间', exclusive: false, picks: [
        { text: '🏅 竞选学生会', effect: { mental: 5, health: -5, money: -3, flags: { studentGov: true } } },
  ...
  s3_dating_app: {
    ...
    choices: [
      { text: '🍷 约一个看起来不错的出来见面', hint: '心理+8, 体力-8, 金钱-10', next: 's3_date_meetup', effect: { mental: 8, health: -8, money: -10 } },
  ...
  s3_date_meetup: {
    ...
    text: '你们约在了淮海路的一家酒吧。\n\n对方比照片好看一点。聊得也还行。\n几杯酒下肚，氛围越来越暧昧。\n\n"要不……去我那边坐坐？"\n\n你的心跳快了几拍。',
    choices: [
      { text: '😏 走，去看看', hint: '心理+9, 体力-12, 金钱-10', next: 's3_hookup', effect: { mental: 9, health: -12, money: -10, flags: { hookup: true, _romanceCount: 1 } } },
      { text: '🙂 今天太晚了，下次吧', hint: '心理+3', next: 's4_intro', effect: { mental: 3 }, semester: 4 },
      { text: '❤️ 我觉得你人挺好的，但我想认真了解你', hint: '心理+8, 金钱-10', next: 's3_date_serious', effect: { mental: 8, money: -10, flags: { _romanceCount: 1 } } },
    ],
  },
  s3_hookup: {
    icon: '🌃', title: '那一夜',
    ...
    choices: [
      { text: '📱 之后还有联系，偶尔约', hint: '心理+5, 体力-5, 金钱-8', next: 's4_intro', effect: { mental: 5, health: -5, money: -8, flags: { casualDating: true } }, semester: 4 },
  ...
  s4_intro: {
    ...
    text: '同学之间的差距开始拉大。\n有人发了论文，有人还在挣扎求过。\n有人已经想好了未来，有人还在迷茫。\n\n你呢？',
    choices: [
      { text: '💡 尝试创业', hint: '心理+7, GPA-0.3, 体力-10, 金钱-10', next: 's4_mid', effect: { mental: 7, gpa: -0.3, health: -10, money: -10, flags: { startup: true } } },
      { text: '📊 目标保研，全力冲GPA', hint: 'GPA+0.3, 体力-15, 心理-15', next: 's4_mid', effect: { gpa: 0.3, health: -15, mental: -15, flags: { aimPostgrad: true } } },
      { text: '🌍 准备出国，考托福GRE', hint: 'GPA+0.1, 体力-12, 心理-10, 金钱-15', next: 's4_mid', effect: { gpa: 0.1, health: -12, mental: -10, money: -15, flags: { aimAbroad: true } } },
  ...
  s4_cs_pro: {
    ...
    choices: [
      { text: '🔫 继续追梦，报名CUPC大学生联赛', hint: '心理+10, GPA-0.1, 体力-10, 金钱-5', next: 's4_cs_cupc', effect: { mental: 10, gpa: -0.1, health: -10, money: -5 } },
  ...
  s4_mid: {
    ...
    choices: function() {
      ...
      if (Game.state.flags.casualDating) {
        c.push({ text: '📱 约了个人出来"散散心"', hint: '心理+7, 体力-10, 金钱-10', next: 's4_booty_call', effect: { mental: 7, health: -10, money: -10 } });
      }
      return c;
    },
  },
  s4_late_swipe: {
    ...
    choices: [
      { text: '☀️ 约出来见个面吧', hint: '心理+8, 金钱-10', next: 's4_end', effect: { mental: 8, money: -10, flags: { datingApp: true } } },
  ...
  s5_intro: {
    ...
    groups: [
      ...
      { label: '📅 课余安排', exclusive: false, picks: [
        ...
        { text: '🍺 周末约朋友放松', effect: { mental: 5, money: -5 } },
  ...
  s5_crisis: {
    ...
    choices: function() {
      var c = [
        ...
        { text: '🍺 约朋友喝酒', hint: '心理+8, 体力-10, GPA-0.1, 金钱-10', next: 's5_end', effect: { mental: 8, health: -10, gpa: -0.1, money: -10 } },
      ...
      if (Game.state.flags.inRelationship || Game.state.flags.casualDating) {
        c.push({ text: '📱 分手/断联后疯狂刷交友软件', hint: '心理+7, 体力-8, 金钱-8', next: 's5_rebound', effect: { mental: 7, health: -8, money: -8, flags: { inRelationship: false, casualDating: false, datingApp: true } } });
      }
      return c;
    },
  },
  ...
  s6_intro: {
    ...
    groups: [
      ...
      { label: '📅 课余时间', exclusive: false, picks: [
        ...
        { text: '🍺 和朋友们好好聚聚', effect: { mental: 8, money: -5 } },
  ...
  s6_senior_crush: {
    ...
    choices: function() {
      if (Math.random() < 0.4) {
        return [
          { text: '💕 TA笑了：其实我也是', hint: '心理+18, 金钱-8', next: 's6_senior_yes', effect: { mental: 18, money: -8, flags: { inRelationship: true, seniorLove: true, _romanceCount: 1 } } },
        ];
      }
      return [
  ...
  s7_intro: {
    ...
    choices: [
      ...
      { text: '💼 疯狂冲秋招', hint: '心理-7, 体力-18, GPA-0.1, 金钱-5', next: 's7_mid', effect: { mental: -7, health: -18, gpa: -0.1, money: -5, flags: { jobHunting: true } } },
  ...
  s8_intro: {
    ...
    choices: function() {
      var c = [
        ...
        { text: '🍻 毕业旅行', hint: '心理+15, 体力-8, GPA-0.1, 金钱-15', next: 's8_defense', effect: { mental: 15, health: -8, gpa: -0.1, money: -15 } },
      ];
      if (Game.state.flags.inRelationship && !Game.state.flags.seniorLove) {
        c.push({ text: '💍 和恋人认真谈谈未来', hint: '心理+9, 金钱-8', next: 's8_future_talk', effect: { mental: 9, money: -8 } });
      }
      return c;
    },
  },
  s8_future_talk: {
    ...
    choices: [
      { text: '💕 不管去哪，在一起就好', hint: '心理+9, 金钱-8', next: 's8_defense', effect: { mental: 9, money: -8, flags: { togetherAfterGrad: true } } },
  ...
  v1_winter: {
    ...
    groups: [
      ...
      { label: '📅 假期活动', exclusive: false, picks: [
        ...
        { text: '🎆 和高中死党聚会', effect: { mental: 8, money: -8 }, loc: 'home' },
        ...
        { text: '🎸 寒假学吉他', effect: { mental: 5, money: -5, flags: { _musicCount: 1, guitar: true } } },
      ]},
    ],
  },
  v2_summer: {
    ...
    groups: [
      { label: '📍 暑假去哪', exclusive: true, picks: [
        ...
        { text: '🏖️ 来一场旅行', effect: { mental: 10, money: -10 }, locId: 'travel' },
      ...
      { label: '📅 暑假安排', exclusive: false, picks: [
        ...
        { text: '🚗 报名学车', effect: { money: -10, mental: 3, health: -3 } },
        { text: '⚽ 参加暑期足球训练营', effect: { health: 8, mental: 5, money: -3, flags: { _sportCount: 1, footballTraining: true } }, loc: 'campus' },
        { text: '🎵 学一门乐器', effect: { mental: 8, money: -8, flags: { _musicCount: 1 } } },
      ]},
    ],
  },
  v3_winter: {
    ...
    groups: [
      ...
      { label: '📅 假期活动', exclusive: false, picks: [
        { text: '📱 天天有局，社交密集期', effect: { mental: 8, money: -10 }, loc: 'home' },
  ...
  v4_summer: {
    ...
    groups: [
      ...
      { label: '📅 另外还想', exclusive: false, picks: [
        { text: '🌍 来一趟旅行', effect: { mental: 10, money: -12 } },
        ...
        { text: '🎸 暑假组乐队排练', effect: { mental: 8, money: -5, flags: { _musicCount: 1, bandFormed: true } }, loc: 'campus', condition: function(s) { return (s.flags._musicCount || 0) >= 1; } },
      ]},
    ],
  },
  v5_winter: {
    ...
    groups: [
      ...
      { label: '📅 额外安排', exclusive: false, picks: [
        ...
        { text: '🧧 和亲戚朋友聚聚', effect: { mental: 5, money: -5 }, loc: 'home' },
      ]},
    ],
  },
  v6_summer: {
  ...
  v7_winter: {
    ...
    groups: [
      ...
      { label: '📅 还想做的事', exclusive: false, picks: [
        { text: '🍻 和大学好友"最后的聚会"', effect: { mental: 8, money: -8 } },
